...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/', component: AppLayout, redirect: '/dashboard', children: [
      ...
      { path: 'coupons', component: () => import('@/views/BusinessView.vue'), meta: { title: '优惠券', kind: 'coupon' } },
      { path: 'reviews', component: () => import('@/views/BusinessView.vue'), meta: { title: '评价管理', kind: 'review' } },
